...
class TestUserAddToBasketFromProductPage():
    ...
    def setup(self, browser):
        ...
        login_page.register_new_user(email=email, password="worofpass")
    ...
    def test_user_can_add_product_to_basket(self, browser):
        ...
        product_page.open()
        product_page.push_the_basket_button()
        #product_page.solve_quiz_and_get_code()
        product_page.should_be_prooduct_title_in_add_to_basket_message()
...
def test_message_disappeared_after_adding_product_to_basket(browser):
    ...
    product_page.open()
    product_page.push_the_basket_button()
    product_page.should_be_success_message_disappear()
